# Aprendizado por Projeto Integrado (API) - 1º Semestre
...
### Mindset Digital
Ao final, como o mapa demonstra, o projeto não entregou apenas produtos técnicos, mas também consolidou competências valiosas em análise de negócios, gestão ágil e resiliência para resolver problemas complexos. Em resumo, o projeto percorreu com sucesso o caminho de uma ideia inicial até uma ferramenta de decisão estratégica
...
- [x] Calcular a necessidade de compra de lotes
- [x] incluir a receita de pacotes de serviço
